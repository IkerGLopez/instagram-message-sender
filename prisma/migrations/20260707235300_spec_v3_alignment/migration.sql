...
-- Rename index from created_at to received_at (drop ASC, recreate with DESC per spec)
ALTER INDEX "webhook_events_created_at_idx" RENAME TO "webhook_events_received_at_idx";
-- Recreate with DESC sort order per spec v3.0.0
...
ALTER TABLE "webhook_events" ALTER COLUMN "event_type" TYPE VARCHAR(64) USING LEFT("event_type", 64);

-- Column type: instagram_user_id TEXT → VARCHAR(64)
ALTER TABLE "webhook_events" ALTER COLUMN "instagram_user_id" TYPE VARCHAR(64) USING LEFT("instagram_user_id", 64);
...
ALTER TABLE "instagram_followers" ADD COLUMN "follow_count" INTEGER NOT NULL DEFAULT 1;

-- Column type: instagram_user_id TEXT → VARCHAR(64)
ALTER TABLE "instagram_followers" ALTER COLUMN "instagram_user_id" TYPE VARCHAR(64) USING LEFT("instagram_user_id", 64);
...
ALTER TABLE "instagram_comments" ALTER COLUMN "comment_id" TYPE VARCHAR(64) USING LEFT("comment_id", 64);

-- Column type: instagram_user_id TEXT → VARCHAR(64)
ALTER TABLE "instagram_comments" ALTER COLUMN "instagram_user_id" TYPE VARCHAR(64) USING LEFT("instagram_user_id", 64);

-- Column type: media_id TEXT → VARCHAR(64)
ALTER TABLE "instagram_comments" ALTER COLUMN "media_id" TYPE VARCHAR(64) USING LEFT("media_id", 64);
...
-- Column type: instagram_user_id TEXT → VARCHAR(64)
ALTER TABLE "dm_records" ALTER COLUMN "instagram_user_id" TYPE VARCHAR(64) USING LEFT("instagram_user_id", 64);

-- Column type: comment_id TEXT → VARCHAR(64)
ALTER TABLE "dm_records" ALTER COLUMN "comment_id" TYPE VARCHAR(64) USING LEFT("comment_id", 64);

-- Column type: media_id TEXT → VARCHAR(64)
ALTER TABLE "dm_records" ALTER COLUMN "media_id" TYPE VARCHAR(64) USING LEFT("media_id", 64);

-- Column type: discount_code TEXT → VARCHAR(64)
ALTER TABLE "dm_records" ALTER COLUMN "discount_code" TYPE VARCHAR(64) USING LEFT("discount_code", 64);

-- Column type: dm_message_id TEXT → VARCHAR(128)
ALTER TABLE "dm_records" ALTER COLUMN "dm_message_id" TYPE VARCHAR(128) USING LEFT("dm_message_id", 128);
